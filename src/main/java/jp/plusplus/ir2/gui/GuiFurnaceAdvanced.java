...
public class GuiFurnaceAdvanced extends GuiContainer {
    protected TileEntityFurnaceAdvanced entity;
    protected ISidedInventory inventory;

    public GuiFurnaceAdvanced(Container container, TileEntityFurnaceAdvanced tileEntity){
        super(container);
        entity=tileEntity;
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
        ...
        this.drawTexturedModalRect(k+70, l+26, 176, 0, entity.getProgressScaled(22), 15);
    }
}
