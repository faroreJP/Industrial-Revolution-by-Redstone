 ...
 */
public class TileEntityFurnace extends TileEntityMachineBase implements ISidedInventory {
    ...
    public boolean canWork() {
        ...
        ItemStack result = FurnaceRecipes.smelting().getSmeltingResult(itemStacks[0]);
    ...
    public String getInventoryName() {
        return I18n.format("gui.redstoneFurnace");
    }
    @Override
    ...
    public boolean canInsertItem(int i, ItemStack itemstack, int j) {
        return j!=side && j!=sideCarrying && isItemValidForSlot(i, itemstack);
    }
    @Override
