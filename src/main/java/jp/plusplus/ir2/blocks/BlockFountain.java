 ...
 */
public class BlockFountain extends BlockMachineBase {
    protected BlockFountain() {
        super("fountain", 1, "Obsidian");
        setBlockTextureName(IR2.MODID + ":machineFountain2Front");
