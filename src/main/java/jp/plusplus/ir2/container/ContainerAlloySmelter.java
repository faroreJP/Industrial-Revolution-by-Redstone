...
public class ContainerAlloySmelter  extends Container {
    ...
    public ContainerAlloySmelter(EntityPlayer player, TileEntityAlloySmelter tileEntity) {
        ...
        this.addSlotToContainer(new SlotWithEXP(player, inventory, 2, 116, 25));
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (par2 == 2) {
                ...
                if (inventory.isItemValidForSlot(0, stack) || inventory.isItemValidForSlot(1, stack)) {
